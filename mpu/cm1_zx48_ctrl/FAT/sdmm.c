...
void SPIxInit()
{
    ...
    init_spi.CLKSEL= CLKSEL_CLK_DIV_2;	//
	init_spi.DIRECTION = DISABLE;		//MSB First
	init_spi.PHASE = DISABLE;			//ENABLE;//posedge
	init_spi.POLARITY = ENABLE;		//polarity 0

	SPI_Init(&init_spi);
	//prt("SPIxInit\n");
}

BYTE SPIx_Transfer (BYTE data_out)
{
	return SPI_ReadWriteByte(data_out);
}
...
#define	CS_H()		SPIx_DisableSlave()	/* Set MMC CS "high" */
#define CS_L()		SPIx_EnableSlave()	/* Set MMC CS "low" */
...
/**************************************************************************/
/*!
    Set SSP clock to slow mode (max. 400 KHz) Fpclk/256 = 281 kHz
*/
/**************************************************************************/
...
/**************************************************************************/
/*!
    Set SSP clock to fast mode Fpclk/4 = 18M
*/
/**************************************************************************/
